...
<div class="body-content">
	<form action="" class="form" id="1">
        ...
        <input type="hidden" name="operation" value="{{ $banner != null ? 'update' : 'create'  }}">
		<div class="data-option">
			<label for="content">Contenido :</label>
			<textarea name="content" class="trumbowyg">{{$banner != null ? $banner->content : ""}}</textarea>
        </div>
        @if ($banner != null && $banner->image != null)
        <div class="data-option">
			<div class="preview">
			<picture>
				<source srcset="{{ asset('storage/images/'.$banner->image->webp) }}" type="image/webp">
				<source srcset="{{ asset('storage/images/'.$banner->image->url) }}" type="image/{{ $banner->image->extension }}" >
				<img src="{{ asset('storage/images/'.$banner->image->url) }}" >
			</picture>
			</div>
		</div>
        @endif
        <div class="data-option">
            ...
            <span>Medidas minimas recomendadas para la imagen: (ancho x alto) 1920 x 1080</span>
