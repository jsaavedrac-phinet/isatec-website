...
<div class="header-content">
	...
	<div class="actions-content">
		<a class="btn btn-add" href="{{ route('admin.post.create', $name) }}">
...
<div class="body-content">
	@if (count($posts) >0)
	<table>
		<caption>Total : {{ count($posts) }}</caption>
		<thead>
			<tr>
		...
		<tbody>
			...
			<tr>
				...
				<td class="acciones">
					<a class="btn btn-edit" href="{{ route('admin.post.edit', [$name,$item->id]) }}"><i class="fas fa-edit"></i>&nbsp;<label>Editar</label></a>
