...
<div class="header-content">
	...
	<div class="title-content">Editar Slider</div>
</div>
<div class="body-content">
	<form action="" class="form" id="1">
		...
		<div class="data-option">
			...
			<textarea name="content" id="content" placeholder="Descripci&oacute;n" class="trumbowyg">{{$slider->content}}</textarea>
        </div>
		<div class="data-option">
			...
			<div class="radio-options with-image">
                <div class="radio-option">
                    ...
                    <input type="radio" value="right-bg.png" name="style" id="option-1" {{ $slider->style == "right-bg.png" ? "checked" : ""}}>
                </div>
                <div class="radio-option">
                    <label for="option-2">
                        <img src="{{ asset('styles/slider/right.png') }}" alt="">
                    </label>
                    <input type="radio" value="right.png" name="style" id="option-2" {{ $slider->style == "right.png" ? "checked" : ""}}>
                </div>
                <div class="radio-option">
                    <label for="option-3">
                        <img src="{{ asset('styles/slider/left-bg.png') }}" alt="">
                    </label>
                    <input type="radio" value="left-bg.png" name="style" id="option-3" {{ $slider->style == "left-bg.png" ? "checked" : ""}}>
                </div>
                <div class="radio-option">
                    <label for="option-4">
                        <img src="{{ asset('styles/slider/left.png') }}" alt="">
                    </label>
                    <input type="radio" value="left.png" name="style" id="option-4" {{ $slider->style == "left.png" ? "checked" : ""}}>
                </div>
                <div class="radio-option">
                    <label for="option-5">
                        <img src="{{ asset('styles/slider/center-bg.png') }}" alt="">
                    </label>
                    <input type="radio" value="center-bg.png" name="style" id="option-5" {{ $slider->style == "center-bg.png" ? "checked" : ""}}>
                </div>
                <div class="radio-option">
                    <label for="option-6">
                        <img src="{{ asset('styles/slider/center.png') }}" alt="">
                    </label>
                    <input type="radio" value="center.png" name="style" id="option-6" {{ $slider->style == "center.png" ? "checked" : ""}}>
                </div>
            </div>
		</div>
		<div class="data-option">
