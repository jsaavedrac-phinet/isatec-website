...
<div class="body-content">
	<form action="" class="form" id="1">
        ...
        <input type="text" name="collection" id="collection" value="{{ $book->collection }}">
		</div>
        <div class="data-option">
            <label for="contents">Contenido :</label>
        <textarea name="contents" class="trumbowyg">{{ $book->contents }}</textarea>
        </div>
        <div class="data-option">
