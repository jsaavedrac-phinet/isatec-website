...
<div class="header-content">
	...
	<div class="actions-content">
		<a class="btn btn-add" href="{{ route('admin.book.create') }}">
...
<div class="body-content">
	@if (count($books) >0)
	<table>
		<caption>Total : {{ count($books) }}</caption>
		<thead>
			<tr>
		...
		<tbody>
			...
			<tr>
				...
				<td class="acciones">
					<a class="btn btn-edit" href="{{ route('admin.book.edit', $item->id) }}"><i class="fas fa-edit"></i>&nbsp;<label>Editar</label></a>
