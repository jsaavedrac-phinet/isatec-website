...
<div class="body-content">
    ...
    <input type="hidden" name="id" value="{{ $section->id }}">
        <div class="data-option">
			...
			<input type="text" name="title" id="title" value="{{ $section->title }}">
		</div>
		<div class="data-option">
			<label for="subtitle">Subt&iacute;tulo (Opcional)</label>
			<input type="text" name="subtitle" id="subtitle" value="{{ $section->subtitle}}">
		</div>
        <div class="data-option">
            <label for="content">Contenido :</label>
            <textarea name="content" class="trumbowyg">{{ $section->content}}</textarea>
        </div>
        ...
        <div class="data-option">
			<div class="preview">
			<picture>
				<source srcset="{{ asset('storage/images/'.$section->image->webp) }}" type="image/webp">
				<source srcset="{{ asset('storage/images/'.$section->image->url) }}" type="image/{{ $section->image->extension }}" >
				<img src="{{ asset('storage/images/'.$section->image->url) }}" >
			</picture>
			</div>
		</div>
        @endif
