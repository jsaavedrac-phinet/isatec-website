...
<head>
	...
	*{padding: 0; margin:0; font-family: 'Open Sans', sans-serif}
	...
	nav ul li{width: calc(100% - 1em); padding:  0.7em 0.5em; list-style: none;}
	nav.extended ul li{width: calc(100% - 2em); padding:  0.7em 1em;}
	nav ul li:hover{background: #2a363b;}
	nav ul li:hover a{color: #FFF;}
	nav ul li a{text-decoration: none; color: var(--nav-item); width: 100%; cursor: pointer; display: flex; position: relative; justify-content: center;}
	...
	nav ul li:hover a .nav-titulo{display: initial;position: absolute;top: -0.1em;left: calc(100% + 0.5em);background: var(--nav-item);padding: 0.2em 1em;}
...
<body>
	@include('template.partials.admin-nav')
	@include('template.partials.admin-bar')
	...
	@include('template.partials.admin-js')
</body>
</html>
